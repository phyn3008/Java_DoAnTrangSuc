...
<jsp:useBean id="daokc" class="dao.KichCoDao"></jsp:useBean>
    <section class="banner1">
        <img src="assets/images/Banner/4.png" alt="banner1">
    </section>
...
<section class="news section">
    ...
    <div class="news__content container">
        <div class="row">
            <div class="col-7">
                <img class="img-fluid" src="assets/images/Banner/6.jpg" alt="">
            </div>
            <div class="col-5">
        ...
        <div class="row">
            ...
            <div class="col-7">
                <img class="img-fluid" src="assets/images/Banner/Banner_Day_Chuyen_2.png" alt="">
            </div>
        </div>
    </div>
</section>
